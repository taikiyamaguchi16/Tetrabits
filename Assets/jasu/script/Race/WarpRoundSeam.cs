...
public class WarpRoundSeam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if(transform.localPosition.z >= raceStageMolder.transform.position.z + raceStageMolder.GetLaneLength + raceStageMolder.GetDummyRoadMolder.GetPlayerWarpPointZ)
            {

		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					float scanLineColorY = sin(_Time.y * 10 + uv.y * 200) / 2 + 0.5;
					//float scanLineColorX = sin(_Time.x * 10 + uv.x * 200) / 2 + 0.5;
					col *= 0.5 + clamp(scanLineColorY + 0.5, _ScanLineBright, 1) * 0.5;
